...
export default function Page() {
  ...
  const handleFileChange = async (event) => {
    ...
    try {
      ...
      setFormdata((prevFormData) => ({
        ...prevFormData,
        file: uploadedImageURL.secure_url,
      }));
    } catch (error) {
  ...
  // Function to validate ticket selection
            ...
            {currentStep === 1 && (
              <div className="container">
                <div className="one">
                  ...
                  <input type="number" value={tickets} required min="1" onChange={(e) => {
